...
class Code_Field extends Field {
	...
	public static function admin_enqueue_scripts() {
		...
		# Enqueue JS
		wp_enqueue_script( 'carbon-field-code', $root_uri . '/assets/js/bundle.js', array( 'carbon-fields-boot' ) );

		# Enqueue CSS
		wp_enqueue_style( 'carbon-field-code', $root_uri . '/assets/css/field.css' );
	}
